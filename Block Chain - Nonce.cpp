...
int main()
{
	...
	while (1)
	{
    	...
    	//cout << target_hash << endl;
    	/*cout<<"index: #"<<nonce<< "block"<<endl;
    	cout<<"nonce: "<<nonce<<endl;
    	cout<<"Previous_hash: "<<previous_hash<<endl;
    	cout<<"Hash: "<<target_hash<<endl<<endl;*/
    	
    	if (target_hash[0] == '0' && target_hash[1] == '0' && target_hash[2] == '0') //target_hash[:prefixed] == '0'*prefixed:  //檢查是否符合條件
      	{
